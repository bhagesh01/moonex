...
const Hero = () => {
  return (
    <div className='min-h-[90vh] md:min-h-screen relative' id='home'>
      ...
      ' />
      <Image 
      src={"./Ellipse-gradient.svg"} 
      alt="gradient" height={600} width={600} className='absolute -right-0 top-56 rounded-full opacity-20 md:right-0 md:top-52' />
      <Image 
      src={"./big-star.svg"} 
      ...
      lg:right-2 top-28 lg:top-2 lg:w-[32rem] animate__animated
      animate__zoomIn'/>
      <Navbar/>
      <div style={{ fontFamily: "var(--font-raleway)" }} className='text-4xl lg:text-7xl relative z-10 font-semibold mt-64 lg:mt-64 lg:ml-64 ml-14
      animate__animated
      animate__fadeInUp
      '>
