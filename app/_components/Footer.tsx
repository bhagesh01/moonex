...
const Footer = () => {
  return (
    ...
    <div className='hidden lg:flex'>
      <ul className='flex items-center justify-center gap-14 text-white font-normal text-lg'>
    ...
    <div className='text-center'>
      ...
      <div className='flex items-center justify-center gap-3 pt-3'>
        <a href="https://github.com/bhagesh01/moonex/tree/main" target='_blank' className='p-3 rounded-full hover:bg-[#273a4ceb] transition-all ease-in-out duration-300'>
        <Github />
        </a>
